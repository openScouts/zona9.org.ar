  ...
  <div>
      ...
      <div class="col-sm-4 align-items-stretch">
        <div class="feature-item animated cargando m-2 p-2">
          <a href="https://mirincon.com.ar/" class="c-black">
            <div class="icon-block">
              <h2 class="mdc-text-green-500">
                <i class="zmdi zmdi-codepen zmdi-hc-3x animated infinite pulse zmdi-hc-fw"></i>
              </h2>
              <h5>Mi Rincon</h5>
              <p
      ...
      <div class="col-sm-4 align-items-stretch">
        <div class="feature-item animated cargando m-2 p-2">
          <nuxt-link to="/biblioteca" class="c-black">
            <div class="icon-block">
              <h2 class="mdc-text-green-500">
                <i class="zmdi zmdi-view-day zmdi-hc-3x animated infinite pulse zmdi-hc-fw"></i>
              </h2>
              <h5>Biblioteca</h5>
              <p
                class="mdc-text-grey-700"
    ...
    <mdb-row>
      <template v-for="noti in noticias.data">
        <mdb-col sm="4" v-if="noti.full_picture" :key="noti.created_time" class="mb-4 w-100">
          <mdb-card wide>
